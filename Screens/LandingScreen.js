...
export default function LandingScreen() {
  ...
  function appendInputLog(prefix, msg) {
    setInput(`${input} ${prefix}: ${msg} \n`);
  }
  ...
  return (
    <View>
      <ScrollView style={{height: '40%', backgroundColor: '#fff'}}>
        <Heading size={'xl'}>{output}</Heading>
      </ScrollView>
      <ScrollView style={{height: '40%', backgroundColor: '#fffdc9'}}>
